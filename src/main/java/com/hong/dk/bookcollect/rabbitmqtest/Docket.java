...
//
//    private final DocumentationType documentationType; //文档类型
//    private final List<SecurityContext> securityContexts = newArrayList(); //安全上下文
//    private final Map<RequestMethod, List<ResponseMessage>> responseMessages = newHashMap(); //响应消息
//    private final List<Parameter> globalOperationParameters = newArrayList(); //全局参数
...
//    private final Set<String> protocols = newHashSet(); //协议
//    private final Set<String> produces = newHashSet(); //支持的媒体类型
//    private final Set<String> consumes = newHashSet();  //支持的媒体类型
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket extensions(List<VendorExtension> vendorExtensions) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket apiInfo(ApiInfo apiInfo) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket securitySchemes(List<? extends SecurityScheme> securitySchemes) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket securityContexts(List<SecurityContext> securityContexts) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket groupName(String groupName) {
...
//     */
//    public springfox.documentation.spring.web.plugins.Docket pathProvider(PathProvider pathProvider) {
...
//     */
//    public springfox.documentation.spring.web.plugins.Docket globalResponseMessage(RequestMethod requestMethod,
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket globalOperationParameters(List<Parameter> operationParameters) {
...
//     */
//    public springfox.documentation.spring.web.plugins.Docket ignoredParameterTypes(Class... classes) {
//        this.ignorableParameterTypes.addAll(Arrays.asList(classes));
//        return this;
//    }
//
//    public springfox.documentation.spring.web.plugins.Docket produces(Set<String> produces) {
//        this.produces.addAll(produces);
//        return this;
//    }
//
//    public springfox.documentation.spring.web.plugins.Docket consumes(Set<String> consumes) {
//        this.consumes.addAll(consumes);
//        return this;
//    }
//
//    @Incubating("2.3")
//    public springfox.documentation.spring.web.plugins.Docket host(String host) {
//        this.host = defaultIfAbsent(host, this.host);
//        return this;
//    }
//
//    public springfox.documentation.spring.web.plugins.Docket protocols(Set<String> protocols) {
...
//     */
//    public springfox.documentation.spring.web.plugins.Docket alternateTypeRules(AlternateTypeRule... alternateTypeRules) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket operationOrdering(Ordering<Operation> operationOrdering) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket directModelSubstitute(final Class clazz, final Class with) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket genericModelSubstitutes(Class... genericClasses) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket useDefaultResponseMessages(boolean apply) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket apiListingReferenceOrdering(Ordering<ApiListingReference> apiListingReferenceOrdering) {
...
//     */
//    public springfox.documentation.spring.web.plugins.Docket apiDescriptionOrdering(Ordering<ApiDescription> apiDescriptionOrdering) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket enable(boolean externallyConfiguredFlag) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket forCodeGeneration(boolean forCodeGen) {
//        if (forCodeGen) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket pathMapping(String path) {
...
//     */
//    @Incubating("2.1.0")
//    public springfox.documentation.spring.web.plugins.Docket enableUrlTemplating(boolean enabled) {
...
//     * @since 2.4.0
//     */
//    public springfox.documentation.spring.web.plugins.Docket additionalModels(ResolvedType first, ResolvedType... remaining) {
...
//     * @return this Docket
//     */
//    public springfox.documentation.spring.web.plugins.Docket tags(Tag first, Tag... remaining) {
//        tags.add(first);
...
//    }
//
//    springfox.documentation.spring.web.plugins.Docket selector(ApiSelector apiSelector) {
